...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2020 at 07:03 PM
...
(2, 1, 'testuser@gmail.com', 'testuser', '2020-08-25 10:02:54', 'Online', '');
...
--
ALTER TABLE `user_status`
  MODIFY `keypk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
